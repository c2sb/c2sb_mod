...
scrp(CAOS.FAMILY.OBJECT, CAOS.OBJECT_GENUS.LEAF, 6205, CAOS.EVENT.TIMER, function()
    ...
    addv(ov03, 1)
--***************************************************
    new: simp(CAOS.FAMILY.OBJECT, CAOS.OBJECT_GENUS.PLANT, 6204, "BulbBalloon", 0, 10, 4567)
...
scrp(CAOS.FAMILY.OBJECT, CAOS.OBJECT_GENUS.PLANT, 6204, CAOS.EVENT.COLLISION, function()
    ...
    for i = 1, (rand(5, 7)) do
        ...
        new: simp(CAOS.FAMILY.OBJECT, CAOS.OBJECT_GENUS.FOOD, 6203, "BulbBalloon", 0, 11, 4567)
